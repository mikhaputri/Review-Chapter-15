...
void PrefferedCustomer::setPurchaseAmount(double purchaseAmount)
{
    this -> purchaseAmount = purchaseAmount;
}
void PrefferedCustomer::setDiscountLevel(double discountLevel)
{
    this -> discountLevel = discountLevel;
}
double PrefferedCustomer::getPurchaseAmount()
{
